...
const v2TypeDecoder = oneOf$1(constant$1("web"), constant$1("native"), constant$1("citrix"), constant$1("onlineNative"), constant$1("other"));
const v2DetailsDecoder = object$1({
    url: nonEmptyStringDecoder$1
});
const v2IconDecoder = object$1({
    src: nonEmptyStringDecoder$1,
    size: optional$1(nonEmptyStringDecoder$1),
...
const v2ScreenshotDecoder = object$1({
    ...
    size: optional$1(nonEmptyStringDecoder$1),
    type: optional$1(nonEmptyStringDecoder$1),
    label: optional$1(nonEmptyStringDecoder$1)
});
const v2ListensForIntentDecoder = object$1({
    contexts: array$1(nonEmptyStringDecoder$1),
...
const v2IntentsDecoder = object$1({
    ...
    raises: optional$1(dict(array$1(nonEmptyStringDecoder$1)))
});
const v2UserChannelDecoder = object$1({
    broadcasts: optional$1(array$1(nonEmptyStringDecoder$1)),
    listensFor: optional$1(array$1(nonEmptyStringDecoder$1))
});
...
const glue42HostManifestsBrowserDecoder = object$1({
    ...
    type: optional$1(nonEmptyStringDecoder$1.where((s) => s === "window", "Expected a value of window")),
...
const v2LocalizedDefinitionDecoder = object$1({
    ...
    title: optional$1(nonEmptyStringDecoder$1),
    tooltip: optional$1(nonEmptyStringDecoder$1),
    lang: optional$1(nonEmptyStringDecoder$1),
    description: optional$1(nonEmptyStringDecoder$1),
    categories: optional$1(array$1(nonEmptyStringDecoder$1)),
    icons: optional$1(array$1(v2IconDecoder)),
    screenshots: optional$1(array$1(v2ScreenshotDecoder)),
    contactEmail: optional$1(nonEmptyStringDecoder$1),
    supportEmail: optional$1(nonEmptyStringDecoder$1),
    moreInfo: optional$1(nonEmptyStringDecoder$1),
    publisher: optional$1(nonEmptyStringDecoder$1),
...
const allDefinitionsDecoder = oneOf$1(v1DefinitionDecoder, v2DefinitionDecoder);
...
null;delete a[b];}}}}function Va(a){a._valueTracker||(a._valueTracker=Ua(a));}function Wa$1(a){if(!a)return  false;var b=a._valueTracker;if(!b)return  true;var c=b.getValue();var d="";a&&(d=Ta(a)?a.checked?"true":"false":a.value);a=d;return a!==c?(b.setValue(a),true):false}function Xa$1(a){a=a||("undefined"!==typeof document?document:void 0);if("undefined"===typeof a)return null;try{return a.activeElement||a.body}catch(b){return a.body}}
...
function Vi$1(a,b,c,d,e){if(0===(a.mode&1))return a===b?a.flags|=65536:(a.flags|=128,c.flags|=131072,c.flags&=-52805,1===c.tag&&(null===c.alternate?c.tag=17:(b=mh(-1,1),b.tag=2,nh(c,b,1))),c.lanes|=1),a;a.flags|=65536;a.lanes=e;return a}var Wi$1=ua$1.ReactCurrentOwner,dh=false;function Xi$1(a,b,c,d){b.child=null===a?Vg(b,null,c,d):Ug(b,a.child,c,d);}
...
const Intents = ({ handlerFilter, chosenIntentName, onNextButtonClick }) => {
    ...
    reactExports.useEffect(() => {
        const getIntentNames = async () => {
            ...
            const filteredIntents = allIntents.filter((intent) => {
                ...
                const { handlers } = intent;
                return handlers.some((handler) => {
                    if (handlerFilter.applicationNames && !handlerFilter.applicationNames.includes(handler.applicationName)) {
                        return false;
                    }
                    if (handlerFilter.resultType && handler.resultType && handlerFilter.resultType !== handler.resultType) {
                        return false;
                    }
                    if (handlerFilter.contextTypes && (!handler.contextTypes || !handlerFilter.contextTypes.some((contextType) => handler.contextTypes?.includes(contextType)))) {
                        return false;
                    }
                    return true;
                });
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "io-intent-list-wrapper" },
            React.createElement(V, { checkIcon: "check", variant: "single" }, intents.map(({ intentName, isSelected }) => (React.createElement(V.Item, { key: intentName, isSelected: isSelected, onClick: () => handleIntentClick(intentName) }, intentName))))),
        React.createElement(X, { align: "right", variant: "fullwidth" },
            React.createElement(A, { disabled: isNextButtonDisabled, variant: "primary", text: "Next", onClick: handleNextButtonClick }))));
};

const InstanceHandlersDropdown = ({ instances, chosenHandler, onHandlerClick }) => {
    return (React.createElement(Ui, { text: "App Instances", icon: "chevron-down", iconRight: true }, instances.map((handler) => (React.createElement(Ui.Item, { key: handler.instanceId, onClick: () => onHandlerClick(handler) },
        chosenHandler?.instanceId === handler.instanceId ? React.createElement(N, { variant: "check" }) : React.createElement(N, null),
...
const InstanceHandlers = ({ handlers, chosenHandler, onHandlerClick }) => {
    ...
    return (React.createElement(V, { checkIcon: "check", variant: "single" },
        React.createElement(V.ItemSection, null, "Open apps"),
        Object.entries(groupInstances()).map(([appName, instances]) => (React.createElement(V.Item, { key: appName, prepend: instances[0].applicationIcon ? React.createElement(Wi, { src: instances[0].applicationIcon, alt: "" }) : React.createElement(N, { variant: "application" }), onClick: () => handleListItemClick(instances), isSelected: instances.some((instance) => instance.instanceId === chosenHandler?.instanceId), append: instances.length > 1 ? React.createElement(InstanceHandlersDropdown, { instances: instances, chosenHandler: chosenHandler, onHandlerClick: onHandlerClick }) : null }, appName)))));
};

const AppHandlers = ({ handlers, chosenHandler, onHandlerClick }) => {
    return (React.createElement(V, { checkIcon: "check", variant: "single" },
        React.createElement(V.ItemSection, null, "All Available Apps"),
        handlers.map((handler) => (React.createElement(V.Item, { key: handler.id, prepend: handler.applicationIcon ? React.createElement(Wi, { src: handler.applicationIcon, alt: "" }) : React.createElement(N, { variant: "application" }), onClick: () => onHandlerClick(handler), isSelected: !chosenHandler?.instanceId && chosenHandler?.applicationName === handler.applicationName }, handler.applicationTitle || handler.applicationName)))));
};
...
const Handlers = ({ chosenIntentName, config, chosenHandler, showBackButton, setChosenHandler, onActionButtonClick, onBackButtonClick, }) => {
    const io$1 = useCustomIOContext();
    ...
    reactExports.useEffect(() => {
        const unsubOnHandlerAdded = io$1.intents.onHandlerAdded((handler, intentName) => {
        ...
        const unsubOnHandlerRemoved = io$1.intents.onHandlerRemoved((removedHandler, intentName) => {
            if (chosenIntentName && chosenIntentName !== intentName) {
                return;
            }
    ...
    const handleActionButtonClick = () => {
        onActionButtonClick(saveUserChoice);
    };
    return (React.createElement(React.Fragment, null,
        React.createElement(to, { placeholder: "Filter apps", value: searchQuery, iconPrepend: "search", iconAppend: "close", iconAppendOnClick: () => setSearchQuery(""), onChange: (e) => setSearchQuery(e.target.value) }),
        React.createElement("div", { className: "io-intent-list-wrapper" },
        ...
        React.createElement(io, { label: checkboxLabel, onClick: handleCheckboxClick }),
        React.createElement(X, { align: "right", variant: "fullwidth" },
            showBackButton && React.createElement(A, { text: "Back", onClick: onBackButtonClick }),
            React.createElement(A, { disabled: !chosenHandler, variant: "primary", text: "Action", onClick: handleActionButtonClick }))));
};
...
const DefaultIntentResolver = ({ config, io, onUserResponse }) => {
    ...
    const title = reactExports.useMemo(() => getTitle(config, chosenIntentName), [config, chosenIntentName]);
    ...
    const handleActionClick = (saveUserChoice) => {
    ...
    return (React.createElement(CustomIOContextProvider, { io: io },
        React.createElement(Qi, { className: "io-resolver-panel p-16" },
            React.createElement(Qi.Header, null,
                React.createElement(I, { text: "Intent Resolver", size: "large" }),
                config.uiSettings?.showCloseButton !== false && React.createElement(X, null,
                    React.createElement(S, { size: "24", icon: "close", iconSize: "16", onClick: handleCloseButtonClick, tabIndex: -1 }))),
            React.createElement(Qi.Body, null,
                React.createElement("p", { className: "io-text-default-lh16" }, title),
                showIntentsList ? (React.createElement(Intents, { chosenIntentName: chosenIntentName, handlerFilter: config.handlerFilter, onNextButtonClick: handleNextButtonClick })) : (React.createElement(Handlers, { config: config, chosenIntentName: chosenIntentName, chosenHandler: chosenIntentHandler, setChosenHandler: setChosenIntentHandler, onActionButtonClick: handleActionClick, onBackButtonClick: handleBackButtonClick, showBackButton: !!(config.handlerFilter && !config.handlerFilter.intent) }))))));
};
...
export { IOBrowserIntentResolverUIFactory as default };
//# sourceMappingURL=io-browser-intent-resolver-ui.es.js.map
